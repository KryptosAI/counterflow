...
[![verified](https://kryptosai.github.io/counterflow/badge.svg)](https://kryptosai.github.io/counterflow/)
...
See [counterflow-action](https://github.com/KryptosAI/counterflow-action).

## Leaderboard

Live verification results — benchmark, DeFiHackLabs reproductions, real contract
models, ValuePacket — regenerated by CI on every push:
**[kryptosai.github.io/counterflow](https://kryptosai.github.io/counterflow/)**
